<template>
  <div class="main-boody">
    <div v-if="cart.length" class="container padding-bottom-3x mb-1">
      <div>
        <!-- Alert-->
        <div
          v-for="item in cart"
        ...
        >
          ...
          <strong>{{ item.product.discountPercentage }}</strong> Reward Points.
        </div>
        <!-- Shopping Cart-->
        ...
        <div class="shopping-cart-footer">
          ...
          >
            <span class="text-medium"
              >Total: ${{
                cartTotalPrice - item.product.discountPercentage
              }}</span
            >
          </div>
        </div>
        <div class="shopping-cart-footer">
          <div class="column">
            <router-link to="/productlist" class="btn btn-secondary"
              ><i class="icon-arrow-left"></i>&nbsp;Back to
