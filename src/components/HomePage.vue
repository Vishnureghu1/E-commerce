              ...
              <div class="card h-100 p-5">
                ...
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <strong>Discount: {{ item.discountPercentage }}</strong>
                    <strong>
                      <h5 class="card-title">
                        <router-link
        ...
        <div class="offer">
          <div class="small-container">
            <div class="row">
              <div class="col-2">
                <img
                  src="https://i.ibb.co/HF5TncZ/exclusive.png"
                  alt=""
                  class="offer-img"
                />
              </div>
            ...
            <div class="row">
              <div class="col-3">
                ...
                <p>
                  ...
                  Perferendis, quae molestias error id est voluptatibus quos
                  amet numquam aspernatur nam cumque ullam? Veritatis eveniet
                  et, maxime eaque soluta quas modi.
                </p>
                <div class="rating">
                  <i class="fas fa-star"></i>
                  <i class="fas fa-star"></i>
